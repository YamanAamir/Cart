            ...
            <div className="bg-[#ffd042] text-white p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm">
                    We continue to be the leader of engineering products for the golf industry. Prior to bringing a new product to the marketplace, each product is tested vigorously for months (sometimes years) at several of our partner courses. We value the feedback from these partners. This ensures 100% quality control before the first unit is even made. Please check back with us as we continue to add new products.
                  </p>
                </div>
                <div>
                  <h3 className="font-bold text-lg mb-2">Green Grass Pricing</h3>
                  <p className="text-sm">
                   Gain exclusive access to Green Grass pricing and volume discounts
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm">
                    You can also reach us at 1-800-467-2844
or e-mail us at: info@clubpro.com
                  </p>
                </div>
              </div>
            </div>
